use crate::service::fs::ArchiveService;
...
pub async fn download_and_install(
    ...
    crate::util::path::ensure_dir(&runtime_root)?;

    let download_dir = runtime_root.join("_downloads");
    crate::util::path::ensure_dir(&download_dir)?;
    ...
    crate::util::path::ensure_dir(&tmp_extract)?;
