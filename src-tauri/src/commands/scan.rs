use crate::commands::cover::update_game_cover;
use crate::commands::game::{default_game_config, is_nwjs_runtime_dir, normalize_path};
use crate::commands::game_executable::find_renpy_launch_script;
use crate::commands::scan_walk::count_dirs;
...
pub async fn scan_games(
    ...
    crate::service::logger::log_scan_complete(
        imported as usize,
