use crate::commands::cover_resolver::fill_cover_from_config;
use crate::commands::legacy_detection::detect_engine_type;
use crate::commands::state::{AppState, cache_remove};
use crate::db::schema::Game;
use crate::model::{AddGameInput, GameConfig, GameDto, UpdateGameInput};
